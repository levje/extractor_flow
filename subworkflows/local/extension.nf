include { FILTER_LIST_EACH as RENAME_CORTICOPONTINE_F } from '../../modules/local/filtering/filter_with_list.nf'
include { FILTER_LIST_EACH as RENAME_CORTICOPONTINE_POT } from '../../modules/local/filtering/filter_with_list.nf'
include { FILTER_LIST_EACH as RENAME_CST } from '../../modules/local/filtering/filter_with_list.nf'

include { TRACTOGRAM_MATH as RENAME_CC_HOMO_FRONTAL } from '../../modules/local/merge/main.nf'
include { TRACTOGRAM_MATH as RENAME_CC_HOMO_OCCIPITAL } from '../../modules/local/merge/main.nf'
include { TRACTOGRAM_MATH as RENAME_CC_HOMO_TEMPORAL } from '../../modules/local/merge/main.nf'
include { TRACTOGRAM_MATH as RENAME_CC_HOMO_PARIETAL } from '../../modules/local/merge/main.nf'

include { TRACTOGRAM_MATH as RENAME_CORTICO_STRIATE } from '../../modules/local/merge/main.nf'
include { TRACTOGRAM_MATH as RENAME_CORONARADIATA } from '../../modules/local/merge/main.nf'
include { TRACTOGRAM_MATH as RENAME_OPTICAL_RADIATION } from '../../modules/local/merge/main.nf'
include { TRACTOGRAM_MATH as RENAME_SLF } from '../../modules/local/merge/main.nf'

include { COPY_FILE as RENAME_CC_HOMO_INSULAR } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_CC_HOMO_CINGULUM } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_USHAPE } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_CING } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_AF } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_FORNIX } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_IFOF } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_UF } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_ILF } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_BRAINSTEM } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_CEREBELLUM } from '../../modules/local/utils/copy_file.nf'
include { COPY_FILE as RENAME_ACCX } from '../../modules/local/utils/copy_file.nf'
